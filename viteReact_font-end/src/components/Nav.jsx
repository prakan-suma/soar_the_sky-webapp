                ...
                <div className="container mx-auto">
                    <div className="flex justify-between py-4 text-lg items-center font-semibold text-zinc-800">
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <a href='' class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-lg px-5 py-2 text-center ">Sign Up</a>
                        </div>
                    </div>
                </div>
            </nav>
